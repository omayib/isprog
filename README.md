...
Now I can show the final answer.```markdown
...
`isProg : ℕ ⇀ ℕ` decides whether a natural number encodes a valid **GOTO program** (as used in the WHILE computation model).  
